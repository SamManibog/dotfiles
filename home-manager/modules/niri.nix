...
binds {
    ...
    Mod+A hotkey-overlay-title="Run an Application: tofi" { spawn-sh "pkill wofi; wofi --show drun -a"; }
    Mod+I hotkey-overlay-title="Open a Browser: firefox" { spawn "firefox"; }
    ...
    // Alternatively, there are commands to move just an entire column:
